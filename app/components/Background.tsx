...
export default function Background() {
  ...
  return (
    <div className={"min-h-[800px] h-screen dark:bg-neutral-800 bg-neutral-300 relative pt-32"}>
      ...
      <svg ref={svgRef} className="absolute block bottom-0 border-0 translate-y-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill={colorMode === 'dark' ? "#1e40af" : "#ff5500"} fillOpacity="1" d="M0,192L720,256L1440,224L1440,320L720,320L0,320Z"></path></svg>
    </div>
  )
}